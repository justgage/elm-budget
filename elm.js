...
Elm.Types.make = function (_elm) {
   ...
   var Group = F2(function (a,b) {    return {name: a,total: b};});
   return _elm.Types.values = {_op: _op,Group: Group,Budget: Budget,Expense: Expense,Model: Model,Categorize: Categorize,Undo: Undo,NoOp: NoOp};
};
...
Elm.View.make = function (_elm) {
   ...
   var viewExpense = F2(function (sty,x) {
      ...
      _U.list([A2($Html.h3,_U.list([sty]),_U.list([$Html.text(x.name)]))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text($Basics.toString(x.amount))]))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text(x.cat)]))]));
   });
   ...
   var viewCategory = F2(function (name,total) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text(name)])),$Html.text(A2($Basics._op["++"],"Total: ",$Basics.toString(total)))]));
   });
   var colletCategories = $List$Extra.groupBy(F2(function (l,r) {    return _U.eq(l.cat,l.cat);}));
   var view = F2(function (address,model) {
      ...
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text($Basics.toString(colletCategories(budget.old)))]))
              ,A2($Html.div,_U.list([]),A2($List.map,viewExpenseOld,budget.old))
              ,A2($Html.div,_U.list([]),$List.reverse(A2($List.map,viewExpenseNew,budget.$new)))
              ,A2($Html.div,_U.list([]),A2($List._op["::"],viewUndoButton(address),A2($List.map,viewButton,cats)))]));
   });
