	...
	function (expence, fcats) {
		var fcat = A2(
			...
			A2(
				...
				0,
				{ctor: '[]'}),
			A2(_elm_lang$core$Dict$get, expence.cat, fcats));
		var amount = fcat.amount + expence.amount;
		var expences = {ctor: '::', _0: expence, _1: fcat.expences};
		var updatedCat = {amount: amount, expences: expences};
		return A3(_elm_lang$core$Dict$insert, expence.cat, updatedCat, fcats);
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$View$viewMoney(_p1._1.amount),
					_1: {ctor: '[]'}
				}
			}
		});
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$viewMoney(x.amount),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
			...
			return A2(
				...
				},
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$View$viewExpense(_p2._0),
							_1: {ctor: '[]'}
						}
					}
				});
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$View$viewMoney(left),
							_1: {
								ctor: '::',
								_0: t(' of '),
								_1: {
									ctor: '::',
									_0: _user$project$View$viewMoney(catBudgeted.budgeted),
									_1: {
										ctor: '::',
										_0: t(' left'),
										_1: {ctor: '[]'}
						...
						_elm_lang$core$List$concat(
							{
								...
								_0: {
									ctor: '::',
									_0: _user$project$View$viewUndoButton,
									_1: {
										ctor: '::',
										_0: _user$project$View$viewDeferButton,
										_1: {ctor: '[]'}
									}
								},
								_1: {
